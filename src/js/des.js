function Des(magnetString,mode){
    var beforeString = input(magnetString.value,mode);
    var textarea = document.getElementById("magnetString1");
    textarea.innerHTML = beforeString;
}
function input(data,mode){
    var key= "5TiU8JyhVz7=";
    if(mode === 1){
        var mw = encMe(key,data);
        return mw;
    }else if(mode === 0){
        var umw = uncMe(key,data);
        return umw;
    }
...
function des(key,message,encrypt,mode,iv){
    ...
    else {tempresult+=String.fromCharCode(((left>>>16)&0xffff),(left& 0xffff),((right>>>16)&0xffff),(right&0xffff));}/*����ʱ���˫�ֽ�*/
